...
-- ─────────────────────────────────────────────────────────────
-- ┌── supabase/migrations/0021_google_evento_sync.sql
...
-- ─────────────────────────────────────────────────────────────
-- ┌── supabase/migrations/0022_inicio_forja_sync.sql
...
-- ─────────────────────────────────────────────────────────────
-- ┌── supabase/migrations/0023_fase_forja_sync.sql
...
-- ─────────────────────────────────────────────────────────────
-- ┌── supabase/migrations/0024_clickup_puxado_em.sql
